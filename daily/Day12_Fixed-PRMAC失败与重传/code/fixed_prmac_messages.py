"""Day12-compatible Fixed-PRMAC frame and reservation-state models.

This module preserves the Day09-Day11 public fields and adds ``failed_at`` so
Day12 can distinguish a retryable REJECTED attempt from the final FAILED
attempt after the retry limit is exhausted. Earlier-day files are not modified.
"""
...
class ReservationStatus(str, Enum):
    """Lifecycle state of one path-segment reservation attempt."""
...
class ReservationRecord:
    """State stored for one requested path-segment reservation attempt."""
